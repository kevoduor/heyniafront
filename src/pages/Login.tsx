...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-muted flex items-center justify-center p-4">
      {/* Card Container */}
      <div className="w-full max-w-5xl bg-card rounded-2xl shadow-2xl border overflow-hidden">
          ...
          <div className="p-8 md:p-10">
            ...
            <form className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <button type="button" className="flex items-center justify-center px-4 py-3 bg-white text-gray-900 border rounded-lg hover:bg-white/90 transition">
                ...
                <button type="button" className="flex items-center justify-center px-4 py-3 bg-black text-white border rounded-lg hover:bg-black/90 transition">
