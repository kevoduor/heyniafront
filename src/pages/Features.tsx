              ...
              {features.map((feature, index) => (
                <div key={index} className="bg-card rounded-xl p-6 border">
                  <div className="w-10 h-10 rounded-full bg-brand-pink/10 flex items-center justify-center mb-4">
                    <PremiumIcon name={index === 0 ? 'unified-data' : index === 1 ? 'reliable-answers' : 'clinic-intelligence'} className="w-5 h-5 text-brand-pink" />
                  </div>
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {realTimeFeatures.map((feature, index) => (
                <div key={index} className="bg-card rounded-xl p-6 border">
                  <div className="w-10 h-10 rounded-full bg-brand-pink/10 flex items-center justify-center mb-4">
                    <PremiumIcon name={index === 0 ? 'clarity' : index === 1 ? 'visualize-data' : 'best-ai'} className="w-5 h-5 text-brand-pink" />
                  </div>
